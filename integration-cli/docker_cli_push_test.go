...
func (s *DockerTrustSuite) TestTrustedPush(c *check.C) {
	...
	contents, err := ioutil.ReadDir(filepath.Join(cli.ConfigurationDir(), "trust/private/tuf_keys", privateRegistryURL, "dockerclitrusted/pushtest"))
...
func (s *DockerTrustSuite) TestTrustedPushWithReleasesDelegationOnly(c *check.C) {
	...
	// Try pull after push
	os.RemoveAll(filepath.Join(cli.ConfigurationDir(), "trust"))
